...
form.addEventListener('submit', e => {
    ...
    const includeUpercase = includeNumbersElement.checked
    const includeUpercase = includeSymbolsElement.checked
    const password = generatePassword(characterAmount, includeUpercase, 
